...
class ConsoleServer:
    def __init__(self, root: Path, data_dir: Path, token_file: Path) -> None:
        ...
        self.profile_context = RunProfileContext(self.root, self.data_dir, self.profiles, self.bindings, self.endpoints)
    ...
    def list_runs(self) -> list[dict[str, Any]]:
        ...
        for path in self.data_dir.iterdir():
            ...
            execution = None
            try:
                profile_context = self.profile_context.get(path.name)
            except Exception as exc:
                profile_context = {"resolutionStatus": "CHAT_IDENTITY_INVALID", "blockReason": "CHAT_IDENTITY_INVALID", "error": str(exc)}
            try:
    ...
    def run_detail(self, run_id: str) -> dict[str, Any]:
        ...
        return {
            ...
            "profileContext": self.profile_context.get(run_id),
        }
    ...
    async def api_delivery_prepare(self, request: web.Request) -> web.Response:
        ...
        try:
            ...
            job["profileDelivery"] = {
                ...
                "timeoutSec": int(authorization.get("endpointWaitTimeoutSec") or 0) if authorization.get("waiting") else None,
            }
