...
(() => {
  ...
  function defaultProfile() {
    return {
      ...
      delivery:{offlineTargetPolicy:'wait',endpointWaitTimeoutSeconds:3600}, directives:{},
  ...
  async function openProfile(profileId = null) {
    ...
    $('endpointTimeoutInput').value = p.delivery?.endpointWaitTimeoutSeconds ?? 3600;
  ...
  async function saveProfile() {
    try {
      ...
      const body = {
        ...
        delivery:{offlineTargetPolicy:$('offlinePolicyInput').value,endpointWaitTimeoutSeconds:Number($('endpointTimeoutInput').value || 3600)},
